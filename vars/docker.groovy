             ...
             stage('Docker Build') {
                ...
                steps {                    
                    sh """
                       ...
                       echo "build Image"
                       docker build -t ${params.COMPONENT}:\${GIT_TAG} .
                       docker push 608320470413.dkr.ecr.us-east-1.amazonaws.com/${params.COMPONENT}:\${GIT_TAG}
                       docker tag 608320470413.dkr.ecr.us-east-1.amazonaws.com/${params.COMPONENT}:\${GIT_TAG} 608320470413.dkr.ecr.us-east-1.amazonaws.com/cart:latest
